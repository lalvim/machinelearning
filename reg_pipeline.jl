...
begin
    ...
    import DataFrames: describe, select, Not, rename!,first
	import Plots: bar,plot,plot!,scatter,scatter!,histogram,histogram!	
end	
...
begin 
	...
	predictor = standardizer |> linear_regressor
end	
...
begin
	...
	coefs = fp.linear_regressor.coefs
...
begin
	nomes = string.(first.(coefs))
    valores = last.(coefs)
	bar(nomes, valores, legend=false, xlabel="Variáveis", ylabel="Coeficientes", title="Coeficientes das Variáveis")
end	
...
manifest_format = "2.0"
project_hash = "1610aabecd1867e636b2977274e84114e298fdfe"

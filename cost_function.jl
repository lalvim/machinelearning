...
begin
	...
	plot(x,y,xlims = (0,300),ylims =   (0,900),xlabel="Metros",ylabel="Preço",label="estimado");
	scatter!(χ[:,2],γ[:],xlims = (0,300),ylims = (0,900),label="exemplo");
end
...
manifest_format = "2.0"
project_hash = "b1905e560bd01be26af7fad9ea89230558d114c7"

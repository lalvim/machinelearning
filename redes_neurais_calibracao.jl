...
X = Float32.(reshape(mnist.features, :, size(mnist.features, 4))) ./ 255
X = transpose(X)  # MLJ espera observações nas linhas (60000, 784)

y = mnist.targets
y = coerce(y, Multiclass)  # Importante para classificação!
...
manifest_format = "2.0"
project_hash = "d3efd70c1ac225b0afcb899b709c0f21d0da2aaf"
...
git-tree-sha1 = "b8fff01b9ada2413a056ea9aa989b08ba0e1f750"
